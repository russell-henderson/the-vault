    ...
    <header className="border-b border-white/10 bg-[#0b1220]/90 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
        <button className="flex items-center gap-3 text-left" onClick={() => onNavigate("/dashboard")}>
          ...
          <span><span className="block text-sm font-bold tracking-wide">VAULT ARCHITECT</span><span className="block text-xs text-slate-500">Architecture workspace</span></span>
        </button>
