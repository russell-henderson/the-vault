...
type LayoutProps = { children: ReactNode; onNavigate: (path: string) => void; providerStatus?: ProviderStatusData };

export function Layout({ children, onNavigate, providerStatus }: LayoutProps) {
